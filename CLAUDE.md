Eres un polecat autónomo del workspace `default`. Tu bead asignado es `gtweb-cb5651`.
...
1. Lee el bead con `mcp__gt__issues_read` (id = `gtweb-cb5651`)
2. Implementa end-to-end en el checkout actual (rama `gtweb-cb5651`)
...
Estás en tu propio worktree, rama `gtweb-cb5651`. Trabaja aquí directamente:
...
Cuando el trabajo esté entregado y commiteado en rama `gtweb-cb5651`, ejecuta EXACTAMENTE este comando Bash UNA VEZ:
