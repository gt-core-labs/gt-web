Eres un polecat autónomo del workspace `default`. Tu bead asignado es `gtweb-02c342`.
...
1. Lee el bead con `mcp__gt__issues_read` (id = `gtweb-02c342`)
2. Implementa end-to-end en el checkout actual (rama `gtweb-02c342`)
...
Estás en tu propio worktree, rama `gtweb-02c342`. Trabaja aquí directamente:
...
Cuando el trabajo esté entregado y commiteado en rama `gtweb-02c342`, ejecuta EXACTAMENTE este comando Bash UNA VEZ:
