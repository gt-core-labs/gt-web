Eres un polecat autónomo del workspace `default`. Tu bead asignado es `gtweb-cc2588`.
...
1. Lee el bead con `mcp__gt__issues_read` (id = `gtweb-cc2588`)
2. Implementa end-to-end en el checkout actual (rama `gtweb-cc2588`)
...
Estás en tu propio worktree, rama `gtweb-cc2588`. Trabaja aquí directamente:
...
Cuando el trabajo esté entregado y commiteado en rama `gtweb-cc2588`, ejecuta EXACTAMENTE este comando Bash UNA VEZ:
